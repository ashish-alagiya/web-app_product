...
class EliquidView extends StatefulWidget {
  const EliquidView({super.key});

  @override
  State<EliquidView> createState() => _EliquidViewState();
}

class _EliquidViewState extends State<EliquidView> {
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              "Find all the best vape pods from leading vape manufacturers like Voopoo, Suorin, Aspire, SMOK, MYLÉ and many more at CSVAPE.",
                                              style: TextStyle(
