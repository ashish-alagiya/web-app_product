...
class PodSystemView extends StatefulWidget {
  const PodSystemView({super.key});

  @override
  State<PodSystemView> createState() => _PodSystemViewState();
}

class _PodSystemViewState extends State<PodSystemView> {
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              "Find all the best vape pods from leading vape manufacturers.re accessible, easy to take with you when you are on the .",
                                              style: TextStyle(
