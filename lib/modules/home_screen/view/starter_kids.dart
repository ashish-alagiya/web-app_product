...
class StarterKidsView extends StatefulWidget {
  const StarterKidsView({super.key});

  @override
  State<StarterKidsView> createState() => _StarterKidsViewState();
}

class _StarterKidsViewState extends State<StarterKidsView> {
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                      ...
                                      child: SizedBox(
                                        height: 100,
                                        child: Image.asset(AppAsset.dazeOhmlet),
                                      )),
                                  const SizedBox(
                                    width: 20,
                                  ),
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              "Are you wondering where to buy vapor cigarettes or which is the best e cigarette vaporizer.",
                                              style: TextStyle(
