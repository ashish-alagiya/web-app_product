...
class VgodView extends StatefulWidget {
  const VgodView({super.key});

  @override
  State<VgodView> createState() => _VgodViewState();
}

class _VgodViewState extends State<VgodView> {
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                    ...
                                    child: SizedBox(
                                      height: 200,
                                      child: Image.asset(AppAsset.shisha),
                                    )),
                                const SizedBox(
                                  width: 20,
                                ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "VGOD is a Well Renowned E-Liquid Company and TrickTeam! All VGOD E-Liquids are Tested, Produced, and Bottled in the USA using only Premium USP Ingredients ensuring a Safe Vaping Experience for all of our Customers! VGOD E-Liquid are Max VG, producing a High Density Vapor content while instilling maximum Flavor! Featuring a 6 Juice Line, Apparel, and More! VGOD E-Liquid is perfect for those who love Flavor and Vapor! View our selection and let us know in the comments what you think of our products! At CSVape.com we strive for excellence in providing great customer service and helping our customers achieve their Vaping goals!",
                                            style: TextStyle(
